                ...
                <CardContent>
                    ...
                    <Box component="ul" sx={{listStyleType: 'none', pl: 0}}>
                        <Box component="li" sx={{mb: 1}}>
                            <Typography variant="body1" align="left">
                                <strong>Support:</strong> A price level where the stock tends to stop falling and may bounce back up.
                            </Typography>
                        </Box>
                        <Box component="li">
                            <Typography variant="body1" align="left">
                                <strong>Resistance:</strong> A price level where the stock tends to stop rising and may fall back down.
                            </Typography>
                        </Box>
                    </Box>
                    ...
                    <Box component="ul" sx={{listStyleType: 'none', pl: 0}}>
                        <Box component="li" sx={{mb: 1}}>
                            <Typography variant="body1" align="left">
                                <strong>Breakout above resistance:</strong> May mean the price is starting a new upward trend. Traders often consider buying here.
                            </Typography>
                        </Box>
                        <Box component="li">
                            <Typography variant="body1" align="left">
                                <strong>Breakdown below support:</strong> May mean the price is starting to fall further. Traders often consider selling or shorting here.
                            </Typography>
                        </Box>
                    </Box>
                    ...
                    <Box component="ul" sx={{listStyleType: 'none', pl: 0}}>
                        <Box component="li" sx={{mb: 1}}>
                            <Typography variant="body1" align="left">1. Take the <strong>maximum price</strong> of the last 30 days.</Typography>
                        </Box>
                        <Box component="li" sx={{mb: 1}}>
                            <Typography variant="body1" align="left">2. Take the <strong>minimum price</strong> of the last 30 days.</Typography>
                        </Box>
                        <Box component="li" sx={{ mb: 1 }}>
                            <Typography variant="body1" align="left">
                                3. Calculate the{' '}
                    ...
                    <Box component="ul" sx={{listStyleType: 'none', pl: 0}}>
                        <Box component="li" sx={{mb: 1}}>
                            <Typography variant="body1" align="left"><strong>If Forecast &gt; 0:</strong> Consider buying (BUY).</Typography>
                        </Box>
                        <Box component="li">
                            <Typography variant="body1" align="left"><strong>If Forecast &lt; 0:</strong> Consider selling (SELL).</Typography>
                        </Box>
                    </Box>
