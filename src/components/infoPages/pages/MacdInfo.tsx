        ...
        <Container maxWidth="lg">
            <Box sx={{backgroundColor: 'inherit'}}>
                <CardContent>
                    ...
                    <Typography variant="body1" align="left">
                        An <strong>EMA</strong> is a type of moving average that gives more weight to recent prices,
                        making it more responsive to new information than a simple moving average (SMA). This
                        responsiveness helps traders better capture short-term trends.
                    </Typography>
                    ...
                    <Box component="ul" sx={{listStyleType: 'none', pl: 0}}>
                        <Box component="li" sx={{mb: 1}}>
                            <Typography variant="body1" align="left">
                                <strong>Buy Signal:</strong> When the MACD Line crosses <strong>above</strong> the
                                Signal Line
                            </Typography>
                        </Box>
                        <Box component="li">
                            <Typography variant="body1" align="left">
                                <strong>Sell Signal:</strong> When the MACD Line crosses <strong>below</strong> the
                                Signal Line
                            </Typography>
                        </Box>
                    </Box>
                    ...
                    <Typography variant="body1" align="left">
                        The <strong>MACD Histogram</strong> shows the difference between the MACD Line and the Signal
                        Line.
                    ...
                    <Box sx={{bgcolor: 'background.paper', p: 2, borderRadius: 2, my: 2}}>
                        ...
                        <Typography variant="body2" align="left">
                            Suppose a stock has a 12-day EMA of $105 and a 26-day EMA of $100. The MACD Line is $5. If
                            the
                            Signal Line (9-day EMA of MACD) is $3, the histogram value is $2. Since the MACD is above
                            the
