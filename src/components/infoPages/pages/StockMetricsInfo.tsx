            ...
            <Box sx={{textAlign: 'center', mt: 4}}>
                <CardContent>
                    ...
                    <Typography variant="subtitle1" sx={{ mt: 2 }} align="left">
                        <strong>Stock Metrics</strong> are key indicators used to evaluate the performance, value, and potential of a stock. They help investors and traders make informed decisions.
                    </Typography>
                    ...
                    <Typography variant="body1" align="left">
                        Stock metrics provide insights into a company's financial health, market performance, and growth potential. They are essential for:
                    </Typography>
